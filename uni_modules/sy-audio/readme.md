...
<sy-audio :src="require('https://jpx2ink.oss-cn-shanghai.aliyuncs.com/images/audio.mp3')"></sy-audio>

//项目为vue3时 src为本地路径时，使用自定义方法，如下:
<sy-audio :src="toUrl('../..https://jpx2ink.oss-cn-shanghai.aliyuncs.com/images/audio.mp3')"></sy-audio>
methods: {
	toUrl(src){
